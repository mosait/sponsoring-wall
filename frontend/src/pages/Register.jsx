...
const REG_T = {
    de: {
        ...
        euroMinErr: 'Bitte einen Betrag von mindestens 1€ pro Monat eingeben.',
    ...
    ar: {
        ...
        euroMinErr: 'يرجى إدخال مبلغ لا يقل عن 1 يورو شهرياً.',
            ...
            <div className="max-w-4xl w-full grid md:grid-cols-2 bg-white rounded-[2rem] overflow-hidden shadow-[0_0_80px_rgba(255,255,255,0.05)] border border-white/10">
                ...
                <div className="bg-[#1a6b3c] p-8 sm:p-12 text-white flex flex-col justify-between relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 sm:gap-4 mb-6">
                            ...
                            <div className="@container flex-1 min-w-0 flex flex-col items-end gap-2.5 sm:gap-3">
                                ...
                                <div className="flex items-center gap-2 sm:gap-2.5">
                                    ...
                                    <button onClick={() => navigate('/dashboard')}
                                        ...
                                        className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/10 border border-white/20 text-white hover:bg-white/20 transition-all flex items-center justify-center shrink-0">
                                        <LayoutDashboard className="w-4 h-4 sm:w-5 sm:h-5" />
                                    </button>
                                    {/* Language Toggle */}
                                    <button onClick={toggleLang}
                                        className="px-3.5 py-2 sm:px-4 sm:py-2 rounded-xl bg-white/10 border border-white/20 text-white text-xs sm:text-sm font-black tracking-widest hover:bg-white/20 transition-all">
                                        {t.langToggle}
                                    </button>
                                </div>
                            </div>
