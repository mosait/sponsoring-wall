          ...
          <div className="flex items-center gap-2 mt-4 sm:mt-0 flex-wrap">
            ...
            {registerStopMode !== 'open' ? (
              <button onClick={() => handleSetStopMode('open')} disabled={stopModeLoading}
                className="px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-1.5 border bg-emerald-500/10 border-emerald-500/20 text-emerald-400 hover:bg-emerald-500 hover:text-white whitespace-nowrap">
              ...
              <>
                <button onClick={() => handleSetStopMode('full')} disabled={stopModeLoading}
                  className="px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-1.5 border bg-orange-500/10 border-orange-500/20 text-orange-400 hover:bg-orange-500 hover:text-white whitespace-nowrap">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>
                  Reg.: Voll
                </button>
                <button onClick={() => handleSetStopMode('maintenance')} disabled={stopModeLoading}
                  className="px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-1.5 border bg-blue-500/10 border-blue-500/20 text-blue-400 hover:bg-blue-500 hover:text-white whitespace-nowrap">
            ...
            <button onClick={handleToggleLock} disabled={lockLoading}
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-1.5 border whitespace-nowrap ${dashboardLocked ? 'bg-green-500/10 border-green-500/20 text-green-400 hover:bg-green-500 hover:text-white' : 'bg-yellow-500/10 border-yellow-500/20 text-yellow-400 hover:bg-yellow-500 hover:text-white'}`}>
              {dashboardLocked ? (
                <><svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>DB öffnen</>
              ) : (
